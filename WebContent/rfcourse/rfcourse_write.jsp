...
<div class="col-10  col-12-narrower imp-narrower">
	<div id="content">
		...
		<article>
			...
			<!--  게시판 작성 -->
			<br>
			<form name="rfcourseform" method="post" action="">
				<input type="hidden" name="act" value="rfwrite">
				<table>
					<tr>
						<td>제목</td>
					...
					<tr>
						<td>장소명</td>
						<td colspan="2"><input type="text" value="장소를 입력해주세요"
							id="tvlocation" name="tvlocation"></td>
					</tr>
					<tr>
						<td>내용</td>
			...
			<div align="center">
				...
				<a href="<%=root%>rfcourse/rfcourse.jsp"><input type="button" value="취소"></a>
			</div>
